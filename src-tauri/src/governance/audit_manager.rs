 ...
 */
pub fn create_audit_snapshot(ledger: Vec<JournalEntry>, _adjustments: Vec<TaxAdjustment>) -> AuditSnapshot {
    ...
    hasher.update(format!("{}{}", total_amount, record_count).as_bytes());
